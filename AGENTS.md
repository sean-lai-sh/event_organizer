...
- Bookings use the shared club booking profile from `agent/config.yaml` under `oncehub.booking_profile`. MVP scope covers first-time booking only; cancellation, rebooking, and manual-edit sync are out of scope.

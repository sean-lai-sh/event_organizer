...
class AgentRuntimeService:
    ...
    async def submit_approval(self, approval_id: str, request: ApprovalDecisionRequest) -> ApprovalDecisionResponse:
        ...
        # Inject AFTER override_args so client-supplied tool_input can't spoof the approver.
        if action_label == "book_oncehub_room" and isinstance(tool_payload, dict):
            tool_payload = {**tool_payload, "approved_by_user_id": request.decided_by_user_id}
